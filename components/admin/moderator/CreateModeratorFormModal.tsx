...
import { createModerator } from "@/services/moderator.serveice";
import { Gender } from "@/types/moderator.types";
import { ModeratorSchema, TModerator } from "@/zod/moderator.validation";
...
interface CreateModeratorFormModalProps {
  isLoadingSpecialties?: boolean;
}

const defaultValues: TModerator = {
  password: "",
  name: "",
  email: "",
  contactNumber: "",
...
const CreateModeratorFormModal = ({
  isLoadingSpecialties = false,
}: CreateModeratorFormModalProps) => {
            ...
            >
              <div className="grid gap-4 md:grid-cols-2">
                <form.Field
                  name="name"
                  validators={{
                    onChange: ModeratorSchema.shape.name,
                  }}
                >
                  {(field) => (
                    <AppField
                ...
                <form.Field
                  name="email"
                  validators={{
                    onChange: ModeratorSchema.shape.email,
                  }}
                >
                  {(field) => (
                    <AppField
                ...
                <form.Field
                  name="password"
                  validators={{
                    onChange: ModeratorSchema.shape.password,
                  }}
                >
                  {(field) => (
                    <AppField
                ...
                <form.Field
                  name="gender"
                  validators={{
                    onChange: ModeratorSchema.shape.gender,
                  }}
                >
                  {(field) => {
                    const firstError =
                    ...
                    return (
                      <div className="space-y-1.5">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => {
                            field.handleChange(value as TModerator["gender"]);
                            field.handleBlur();
                          }}
                        >
                          <SelectTrigger
...
export default CreateModeratorFormModal;
